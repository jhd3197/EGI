...
export default function HomeScreen({ view, actions }) {
  ...
  return (
    <div style={css('padding:16px 18px 28px;')}>
      ...
      <p style={css("margin:0 0 12px;font:600 13px 'IBM Plex Sans';color:#4A443D;")}>{t('home.lookingFor')}</p>
      ...
      <button onClick={() => actions.setScreen('search')} className="egi-tap" style={css('width:100%;display:flex;align-items:center;gap:10px;padding:13px 14px;background:#fff;border:1px solid #E6E2DC;border-radius:14px;cursor:pointer;text-align:left;box-shadow:0 1px 2px rgba(40,30,20,.04);')}>
        <span aria-hidden="true" style={css('width:18px;height:18px;border:2px solid #B3ABA1;border-radius:50%;position:relative;flex:none;')}>
        ...
        <span style={css("font:400 14px 'IBM Plex Sans';color:#9A938A;")}>{t('home.searchPlaceholder')}</span>
      </button>
      ...
      <button onClick={actions.checkInSelf} className="egi-tap" style={css("width:100%;display:flex;align-items:center;gap:12px;padding:14px;margin-top:11px;background:#E9F4ED;border:1px solid #BFE0CB;border-radius:14px;cursor:pointer;text-align:left;")}>
        <span aria-hidden="true" style={css('width:34px;height:34px;border-radius:10px;background:#1B7A45;position:relative;flex:none;')}>
        ...
        <div style={css('flex:1;min-width:0;')}>
          <div style={css("font:600 14px 'IBM Plex Sans';color:#15683A;")}>{t('home.imOk')}</div>
      ...
      <div style={css('display:grid;grid-template-columns:1fr 1fr;gap:11px;margin-top:11px;')}>
        <button onClick={() => actions.openReport('missing')} className="egi-tap" style={css("display:flex;flex-direction:column;gap:9px;padding:15px 14px;background:#E5343B;border:none;border-radius:13px;cursor:pointer;text-align:left;color:#fff;box-shadow:0 10px 22px -14px rgba(206,53,46,.5);")}>
          <span aria-hidden="true" style={css('width:30px;height:30px;border-radius:9px;background:rgba(255,255,255,.18);position:relative;')}>
          ...
          <span style={css("font:600 14px 'IBM Plex Sans';line-height:1.15;")}>{t('home.reportMissing')}</span>
          <span style={css("font:500 10px 'IBM Plex Mono';color:rgba(255,255,255,.78);")}>{t('home.reportMissingEn')}</span>
        </button>
        <button onClick={() => actions.openReport('safe')} className="egi-tap" style={css("display:flex;flex-direction:column;gap:9px;padding:15px 14px;background:#fff;border:1px solid #E6E2DC;border-radius:13px;cursor:pointer;text-align:left;color:#1A1714;")}>
          <span aria-hidden="true" style={css('width:30px;height:30px;border-radius:9px;background:#E3F2E7;position:relative;')}>
          ...
          <span style={css("font:600 14px 'IBM Plex Sans';line-height:1.15;")}>{t('home.registerSafe')}</span>
          <span style={css("font:500 10px 'IBM Plex Mono';color:#9A938A;")}>{t('home.registerSafeEn')}</span>
        </button>
      </div>
