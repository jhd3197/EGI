...
export default function MeshWarningModal({ view, actions }) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={css("margin:0 0 10px;font:700 17px 'IBM Plex Sans';color:#1A1714;")}>Privacidad de la red local</h2>
        <p style={css("margin:0 0 18px;font:400 13.5px 'IBM Plex Sans';color:#4A443D;line-height:1.5;")}>
          Egi comparte registros de emergencia con dispositivos cercanos por Bluetooth.
          Cualquier persona con la app instalada cerca de ti podría recibir datos
          públicos del registro. ¿Continuar?
        </p>
