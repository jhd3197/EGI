...
export default function SheltersScreen({ view, actions }) {
  ...
  return (
    <div style={css('padding:16px 18px 24px;')}>
      <h1 style={css("margin:0 0 2px;font:700 22px 'IBM Plex Sans';color:#1A1714;letter-spacing:-.01em;")}>Refugios y hospitales</h1>
      <p style={css("margin:0 0 16px;font:400 12.5px 'IBM Plex Sans';color:#8A837A;")}>Personas bajo cuidado · Shelters &amp; hospitals</p>
      ...
      <div style={css('margin-top:16px;padding:14px;border:1px dashed #D8D2C9;border-radius:15px;text-align:center;')}>
        <div style={css("font:600 13px 'IBM Plex Sans';color:#2A2520;")}>¿Eres un refugio u hospital?</div>
        <div style={css("font:400 11.5px 'IBM Plex Sans';color:#8A837A;margin:4px 0 11px;")}>Publica la lista de personas a tu cuidado</div>
        <button onClick={() => actions.openReport('safe')} className="egi-tap" style={css("padding:10px 18px;background:#1A1714;border:none;border-radius:11px;color:#fff;font:600 12.5px 'IBM Plex Sans';cursor:pointer;")}>Registrar personas</button>
      </div>
    </div>
  )
}
