  ...
  return (
    <div style={{ ...css('flex-direction:column;width:256px;flex:none;height:100%;background:#fff;border-right:1px solid #ECE8E2;padding:22px 16px;gap:5px;'), display: v.sidebarDisplay }}>
      <div style={css('display:flex;align-items:center;gap:10px;padding:0 8px 4px;')}>
        ...
        <div>
          <Wordmark size={19} />
          <div style={css("font:500 8.5px 'IBM Plex Mono';color:#A39B90;letter-spacing:.04em;margin-top:4px;")}>{t('nav.egiSub')}</div>
        </div>
      </div>
      ...
      <div style={css('display:flex;align-items:center;gap:8px;margin-bottom:10px;')}>
        <span style={css("font:600 9.5px 'IBM Plex Mono';color:#A39B90;letter-spacing:.04em;flex:none;")}>{t('common.language')}</span>
      ...
      <div style={css('display:flex;align-items:center;gap:10px;margin-top:12px;padding-top:12px;border-top:1px solid #EFEBE5;')}>
        ...
        <button onClick={actions.signOut} className="egi-tap" style={css("border:none;background:transparent;cursor:pointer;font:600 9.5px 'IBM Plex Mono';color:#A39B90;flex:none;")}>{t('common.signOut')}</button>
      </div>
    </div>
  )
}
