...
// Shelters / hospitals (plan-20). These mirror the server `shelters` shape so the
// detail card, capacity bars, service chips and filters work offline before any
// server fetch. `loc`/`count`/`minors` are kept for the legacy list summary.
export const DEMO_INSTI = [
  { id: 's1', disaster: 'd1', name: 'Refugio Cancha Cubierta', loc: 'La Guaira', count: '128 personas',
    minors: '6 menores no acompañados', kind: 'refugio', address: 'Av. Soublette, La Guaira',
    lat: 10.5996, lon: -66.9320, phone: '+58 212-555-0143', whatsapp: '+58 412-555-0143',
    hours: '24 h', capacity_total: 180, capacity_available: 52, beds_available: 40, accepting_new: true,
    trust: 'official', services: ['beds', 'food', 'water', 'medical', 'childcare', 'charging'],
    supply_needs: ['water', 'blankets', 'diapers'], target_populations: ['minors', 'women'] },
  { id: 's2', disaster: 'd1', name: 'Hospital Pérez de León II', loc: 'Petare, Caracas', count: '43 pacientes',
    minors: '2 menores no acompañados', kind: 'hospital', address: 'Petare, Caracas',
    lat: 10.4861, lon: -66.8050, phone: '+58 212-555-0199',
    hours: '24 h', capacity_total: 60, capacity_available: 8, beds_available: 8, accepting_new: true,
    trust: 'official', services: ['beds', 'medical', 'water', 'accessibility'],
    supply_needs: ['medicine'], target_populations: ['minors', 'elderly', 'disabled'] },
  { id: 's3', disaster: 'd1', name: 'Refugio Escuela Bolivariana', loc: 'Maiquetía', count: '210 personas',
    minors: '', kind: 'refugio', address: 'Maiquetía, La Guaira', lat: 10.5990, lon: -66.9810,
    hours: '24 h', capacity_total: 210, capacity_available: 0, beds_available: 0, accepting_new: false,
    trust: 'volunteer', services: ['beds', 'food', 'water', 'pets'],
    supply_needs: ['food', 'water', 'volunteers'], target_populations: ['pets'] },
  { id: 's4', disaster: 'd1', name: 'Hospital Vargas', loc: 'Caracas', count: '67 pacientes',
    minors: '1 menor no acompañado', kind: 'hospital', address: 'San José, Caracas',
    lat: 10.5090, lon: -66.9230, phone: '+58 212-555-0177',
    hours: '24 h', capacity_total: 90, capacity_available: 23, beds_available: 18, accepting_new: true,
    trust: 'official', services: ['beds', 'medical', 'water', 'charging', 'internet'],
    supply_needs: [], target_populations: ['elderly'] },
  { id: 's5', disaster: 'd2', name: 'Hôpital Général', loc: 'Puerto Príncipe', count: '305 pacientes',
    minors: '14 menores no acompañados', kind: 'hospital', address: 'Puerto Príncipe, Ouest',
    lat: 18.5436, lon: -72.3380, hours: '24 h', capacity_total: 320, capacity_available: 15,
    beds_available: 12, accepting_new: true, trust: 'official',
    services: ['beds', 'medical', 'water', 'childcare'],
    supply_needs: ['medicine', 'water', 'food'], target_populations: ['minors', 'women', 'disabled'] },
  { id: 's6', disaster: 'd2', name: 'Refugio Croix-des-Bouquets', loc: 'Ouest, Haití', count: '480 personas',
    minors: '9 menores no acompañados', kind: 'refugio', address: 'Croix-des-Bouquets, Ouest',
    lat: 18.5760, lon: -72.2270, hours: '24 h', capacity_total: 500, capacity_available: 20,
    beds_available: 10, accepting_new: true, trust: 'volunteer',
    services: ['beds', 'food', 'water', 'charging'],
    supply_needs: ['food', 'water', 'blankets', 'volunteers'], target_populations: ['minors', 'elderly'] },
  { id: 's7', disaster: 'd3', name: 'Refugio Maiquetía Norte', loc: 'La Guaira', count: '96 personas',
    minors: '', kind: 'refugio', address: 'Maiquetía Norte, La Guaira', lat: 10.6010, lon: -66.9850,
    hours: '24 h', capacity_total: 120, capacity_available: 24, beds_available: 24, accepting_new: true,
    trust: 'crowd', services: ['beds', 'water'], supply_needs: ['food', 'blankets'],
    target_populations: [] },
]
